...
def traverse_shader_network(shader, material_name, texture_data, path=[], connected_param=""):
    ...
    for input in shader.GetInputs():
        ...
        if connection_info:
            ...
            traverse_shader_network(connected_shader, material_name, texture_data, path.copy(), connected_param)
...
def extract_textures_from_shaders():
...
def create_principled_shaders_with_textures(texture_data):

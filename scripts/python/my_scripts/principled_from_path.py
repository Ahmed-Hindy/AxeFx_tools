    ...
    def createshader(self):
        ...
        for files in textures:
            ...
            if "color" in name or "diff" in name:
                ...
                hou.ui.displayMessage("Couldnt connect " + files, severity=hou.severityType.Message, default_choice=0,
                                      close_choice=0, title="Texture not applied", details_expanded=False)
                texture.moveToGoodPosition()
